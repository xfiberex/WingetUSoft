...
public static class L
{
    ...
    /// <summary>Versión tal como se enseña: winget emite «Unknown» en inglés cuando no la conoce (F-20).</summary>
    public static string VersionText(string? raw) =>
        string.IsNullOrWhiteSpace(raw) || raw.Trim().Equals("Unknown", StringComparison.OrdinalIgnoreCase)
            ? T("version.unknown")
            : raw;

    /// <summary>
    /// Elige entre la forma singular (<c>clave.one</c>) y la plural (<c>clave.other</c>) según <paramref name="count"/>.
    /// </summary>
    /// <remarks>
    /// Hasta F-20 los recuentos se escribían con «(s)» y «(es)» —«26 actualización(es) disponible(s)»—, que no es
    /// español ni ningún otro idioma. El recuento va aparte de los argumentos porque no siempre es el primero:
    /// en «{0} de {1} registros» manda el total, no los mostrados.
    /// </remarks>
    public static string P(string key, int count, params object[] args) =>
        T(key + (UsesSingular(Current, count) ? ".one" : ".other"), args);

    /// <summary>
    /// Regla de plural CLDR de cada idioma. Francés y portugués de Brasil cuentan el 0 como singular
    /// («0 mise à jour disponible»); español, inglés e italiano lo cuentan como plural.
    /// </summary>
    public static bool UsesSingular(AppLang lang, int count) => lang switch
    {
        AppLang.Fr or AppLang.Pt => count is 0 or 1,
        _ => count == 1
    };
    ...
    internal static readonly Dictionary<string, string[]> Map = new()
    {
        ...
        ["crash.title"] = ["Error inesperado", "Unexpected error", "Erro inesperado", "Erreur inattendue", "Errore imprevisto"],
        ["crash.body"] = ["Se ha producido un error inesperado y la aplicación no puede continuar.\n\nLos detalles se han guardado en:\n{0}", "An unexpected error occurred and the application cannot continue.\n\nThe details were saved to:\n{0}", "Ocorreu um erro inesperado e o aplicativo não pode continuar.\n\nOs detalhes foram salvos em:\n{0}", "Une erreur inattendue s'est produite et l'application ne peut pas continuer.\n\nLes détails ont été enregistrés dans :\n{0}", "Si è verificato un errore imprevisto e l'applicazione non può continuare.\n\nI dettagli sono stati salvati in:\n{0}"],
        ["winget.actionCheckUpdates"] = ["consultar actualizaciones", "check for updates", "consultar atualizações", "rechercher des mises à jour", "cercare aggiornamenti"],
        ["winget.actionListInstalled"] = ["listar programas instalados", "list installed programs", "listar programas instalados", "lister les programmes installés", "elencare i programmi installati"],
        ["winget.actionSearch"] = ["buscar paquetes", "search for packages", "pesquisar pacotes", "rechercher des paquets", "cercare pacchetti"],
        ["winget.commandFailed"] = ["winget no pudo {0}. Código de salida: {1}.", "winget could not {0}. Exit code: {1}.", "o winget não conseguiu {0}. Código de saída: {1}.", "winget n'a pas pu {0}. Code de sortie : {1}.", "winget non è riuscito a {0}. Codice di uscita: {1}."],
        ["winget.commandFailedDetail"] = ["winget no pudo {0}. {1} (código de salida: {2}).", "winget could not {0}. {1} (exit code: {2}).", "o winget não conseguiu {0}. {1} (código de saída: {2}).", "winget n'a pas pu {0}. {1} (code de sortie : {2}).", "winget non è riuscito a {0}. {1} (codice di uscita: {2})."],
        ["winget.elevatedAuthFailed"] = ["La sesión elevada no pudo validarse correctamente.", "The elevated session could not be validated.", "A sessão elevada não pôde ser validada corretamente.", "La session élevée n'a pas pu être validée.", "Non è stato possibile convalidare la sessione con privilegi elevati."],
        ["winget.elevatedNoComm"] = ["No se pudo establecer comunicación con la sesión elevada.", "Communication with the elevated session could not be established.", "Não foi possível estabelecer comunicação com a sessão elevada.", "Impossible d'établir la communication avec la session élevée.", "Impossibile stabilire la comunicazione con la sessione con privilegi elevati."],
        ["winget.notFound"] = ["No se encontró una instalación confiable de winget.", "No trusted winget installation was found.", "Não foi encontrada uma instalação confiável do winget.", "Aucune installation fiable de winget n'a été trouvée.", "Nessuna installazione affidabile di winget trovata."],
        ["winget.ownPathUnknown"] = ["No se pudo determinar la ruta del ejecutable actual.", "The path of the current executable could not be determined.", "Não foi possível determinar o caminho do executável atual.", "Impossible de déterminer le chemin de l'exécutable actuel.", "Impossibile determinare il percorso dell'eseguibile corrente."],
        ["settings.invalidFile"] = ["El archivo de configuración '{0}' es inválido o está vacío. Se usarán los valores predeterminados.", "The settings file '{0}' is invalid or empty. Default values will be used.", "O arquivo de configuração '{0}' é inválido ou está vazio. Serão usados os valores padrão.", "Le fichier de configuration « {0} » est invalide ou vide. Les valeurs par défaut seront utilisées.", "Il file di configurazione '{0}' non è valido o è vuoto. Verranno usati i valori predefiniti."],
        ["settings.loadFailed"]  = ["No se pudo cargar la configuración desde '{0}': {1}", "The settings could not be loaded from '{0}': {1}", "Não foi possível carregar a configuração de '{0}': {1}", "Impossible de charger la configuration depuis « {0} » : {1}", "Impossibile caricare la configurazione da '{0}': {1}"],
        ["settings.saveFailed"]  = ["No se pudo guardar la configuración en '{0}': {1}", "The settings could not be saved to '{0}': {1}", "Não foi possível salvar a configuração em '{0}': {1}", "Impossible d'enregistrer la configuration dans « {0} » : {1}", "Impossibile salvare la configurazione in '{0}': {1}"],
        ["log.startingPackage"]  = ["[{0}/{1}] Iniciando: {2} ({3})", "[{0}/{1}] Starting: {2} ({3})", "[{0}/{1}] Iniciando: {2} ({3})", "[{0}/{1}] Démarrage : {2} ({3})", "[{0}/{1}] Avvio: {2} ({3})"],
        ["log.logFileFailed"]    = ["[aviso] No se pudo escribir el archivo de log: {0}", "[warning] The log file could not be written: {0}", "[aviso] Não foi possível gravar o arquivo de log: {0}", "[avertissement] Impossible d'écrire le fichier journal : {0}", "[avviso] Impossibile scrivere il file di log: {0}"],
        ["status.newUpdatesAvailable"] = ["¡Nuevas actualizaciones disponibles!", "New updates available!", "Novas atualizações disponíveis!", "Nouvelles mises à jour disponibles !", "Nuovi aggiornamenti disponibili!"],
        ...
        ["search.found.one"] = ["{0} paquete encontrado.", "{0} package found.", "{0} pacote encontrado.", "{0} paquet trouvé.", "{0} pacchetto trovato."],
        ["search.found.other"] = ["{0} paquetes encontrados.", "{0} packages found.", "{0} pacotes encontrados.", "{0} paquets trouvés.", "{0} pacchetti trovati."],
        ["search.countLabel.one"] = ["{0} resultado", "{0} result", "{0} resultado", "{0} résultat", "{0} risultato"],
        ["search.countLabel.other"] = ["{0} resultados", "{0} results", "{0} resultados", "{0} résultats", "{0} risultati"],
        ...
        // Rótulo de la tecla Supr en el menú contextual: WinUI lo pondría en el idioma de Windows.
        ["key.delete"]        = ["Supr", "Del", "Del", "Suppr", "Canc"],
        ...
        // Sale del estado de error o cancelado del panel de la tabla (F-18).
        ["btn.retry"]         = ["Reintentar", "Retry", "Tentar novamente", "Réessayer", "Riprova"],
        ...
        ["list.stateCancelledBody"]  = ["Pulsa «Reintentar» para volver a intentarlo.", "Click \"Retry\" to try again.", "Clique em «Tentar novamente» para tentar de novo.", "Cliquez sur « Réessayer » pour recommencer.", "Premi «Riprova» per riprovare."],
        // Estados de las listas de Buscar, Desinstalar y Limpieza (F-18).
        ["search.stateInitialTitle"] = ["Busca un programa", "Search for a program", "Procure um programa", "Recherchez un programme", "Cerca un programma"],
        ["search.stateInitialBody"]  = ["Escribe un nombre o un Id arriba y pulsa «Buscar».", "Type a name or an Id above and click \"Search\".", "Digite um nome ou um Id acima e clique em «Procurar».", "Saisissez un nom ou un Id ci-dessus et cliquez sur « Rechercher ».", "Scrivi un nome o un Id sopra e premi «Cerca»."],
        ["uninstall.stateEmptyTitle"] = ["No hay programas que mostrar", "No programs to show", "Não há programas para mostrar", "Aucun programme à afficher", "Nessun programma da mostrare"],
        ["uninstall.stateEmptyBody"]  = ["winget no devolvió ningún programa instalado.", "winget returned no installed programs.", "O winget não retornou nenhum programa instalado.", "winget n'a retourné aucun programme installé.", "winget non ha restituito alcun programma installato."],
        ["cleanup.stateCleanTitle"]   = ["Sin residuos", "No leftovers", "Sem resíduos", "Aucun résidu", "Nessun residuo"],
        ...
        ["confirm.updateBody.one"] = ["Se va a actualizar {0} programa:\n\n  • {1}", "{0} program will be updated:\n\n  • {1}", "{0} programa será atualizado:\n\n  • {1}", "{0} programme va être mis à jour :\n\n  • {1}", "Verrà aggiornato {0} programma:\n\n  • {1}"],
        ["confirm.updateBody.other"] = ["Se van a actualizar {0} programas:\n\n  • {1}", "{0} programs will be updated:\n\n  • {1}", "{0} programas serão atualizados:\n\n  • {1}", "{0} programmes vont être mis à jour :\n\n  • {1}", "Verranno aggiornati {0} programmi:\n\n  • {1}"],
        ...
        ["notif.updatedSuccess.one"] = ["Se actualizó {0} programa correctamente.", "{0} program was updated successfully.", "{0} programa foi atualizado com sucesso.", "{0} programme mis à jour avec succès.", "{0} programma aggiornato correttamente."],
        ["notif.updatedSuccess.other"] = ["Se actualizaron {0} programas correctamente.", "{0} programs were updated successfully.", "{0} programas foram atualizados com sucesso.", "{0} programmes mis à jour avec succès.", "{0} programmi aggiornati correttamente."],
        ...
        ["status.updatesFound.one"] = ["Se encontró {0} actualización disponible{1}.", "{0} available update was found{1}.", "{0} atualização disponível encontrada{1}.", "{0} mise à jour disponible trouvée{1}.", "Trovato {0} aggiornamento disponibile{1}."],
        ["status.updatesFound.other"] = ["Se encontraron {0} actualizaciones disponibles{1}.", "{0} available updates were found{1}.", "{0} atualizações disponíveis encontradas{1}.", "{0} mises à jour disponibles trouvées{1}.", "Trovati {0} aggiornamenti disponibili{1}."],
        ...
        // Texto junto a los interruptores. WinUI lo toma del idioma de Windows, no del de la app: con la app en inglés
        // sobre un Windows en español decían «Activado» (F-16).
        ["toggle.on"] = ["Activado", "On", "Ativado", "Activé", "Attivato"],
        ["toggle.off"] = ["Desactivado", "Off", "Desativado", "Désactivé", "Disattivato"],
        ["settings.themeDesc"] = ["Claro, oscuro o el mismo que Windows.", "Light, dark or the same as Windows.", "Claro, escuro ou o mesmo do Windows.", "Clair, sombre ou le même que Windows.", "Chiaro, scuro o lo stesso di Windows."],
        ["settings.langDesc"] = ["Idioma de toda la interfaz.", "Language of the whole interface.", "Idioma de toda a interface.", "Langue de toute l'interface.", "Lingua di tutta l'interfaccia."],
        ["settings.modeDesc"] = ["Silenciosa: los instaladores se ejecutan sin mostrar sus ventanas. Interactiva: cada instalador muestra su propio asistente.", "Silent: installers run without showing their windows. Interactive: each installer shows its own wizard.", "Silenciosa: os instaladores são executados sem mostrar suas janelas. Interativa: cada instalador mostra seu próprio assistente.", "Silencieux : les programmes d'installation s'exécutent sans afficher leurs fenêtres. Interactif : chacun affiche son propre assistant.", "Silenzioso: i programmi di installazione vengono eseguiti senza mostrare le loro finestre. Interattivo: ognuno mostra la propria procedura guidata."],
        ["settings.adminDesc"] = ["Todo el lote va en un único proceso elevado: Windows pide permiso una vez por lote. Cancelar no interrumpe el programa que se esté actualizando.", "The whole batch runs in a single elevated process: Windows asks for permission once per batch. Cancel does not stop the program being updated.", "Todo o lote é executado em um único processo elevado: o Windows pede permissão uma vez por lote. Cancelar não interrompe o programa que está sendo atualizado.", "Tout le lot s'exécute dans un seul processus élevé : Windows demande l'autorisation une fois par lot. Annuler n'interrompt pas le programme en cours de mise à jour.", "L'intero lotto viene eseguito in un unico processo con privilegi elevati: Windows chiede l'autorizzazione una volta per lotto. Annulla non interrompe il programma in aggiornamento."],
        ["settings.intervalDesc"] = ["Consulta en segundo plano mientras la aplicación está abierta, también minimizada en la bandeja.", "Checks in the background while the app is open, including when minimized to the tray.", "Consulta em segundo plano enquanto o aplicativo está aberto, inclusive minimizado na bandeja.", "Vérifie en arrière-plan tant que l'application est ouverte, y compris réduite dans la barre d'état.", "Controlla in background mentre l'app è aperta, anche quando è ridotta nell'area di notifica."],
        ["settings.logToFileDesc"] = ["Un archivo por día. Los de más de {0} días se borran al abrir la aplicación.", "One file per day. Files older than {0} days are deleted when the app starts.", "Um arquivo por dia. Os com mais de {0} dias são excluídos ao abrir o aplicativo.", "Un fichier par jour. Ceux de plus de {0} jours sont supprimés à l'ouverture de l'application.", "Un file al giorno. Quelli più vecchi di {0} giorni vengono eliminati all'avvio dell'app."],
        ["settings.logFolder"] = ["Carpeta de registros", "Log folder", "Pasta de registros", "Dossier des journaux", "Cartella dei log"],
        ["settings.openFolder"] = ["Abrir carpeta", "Open folder", "Abrir pasta", "Ouvrir le dossier", "Apri cartella"],
        ["settings.openFolderError"] = ["No se pudo abrir la carpeta de registros: {0}", "The log folder could not be opened: {0}", "Não foi possível abrir a pasta de registros: {0}", "Impossible d'ouvrir le dossier des journaux : {0}", "Impossibile aprire la cartella dei log: {0}"],
        ["settings.notificationsDesc"] = ["Sonido y parpadeo en la barra de tareas cuando termina una operación de más de 10 segundos y no estás mirando la ventana.", "A sound and a taskbar flash when an operation longer than 10 seconds finishes while you are not looking at the window.", "Som e piscar na barra de tarefas quando uma operação de mais de 10 segundos termina e você não está olhando a janela.", "Un son et un clignotement dans la barre des tâches quand une opération de plus de 10 secondes se termine alors que la fenêtre n'est pas au premier plan.", "Un suono e un lampeggio sulla barra delle applicazioni quando un'operazione di oltre 10 secondi termina mentre non stai guardando la finestra."],
        ["settings.trayDesc"] = ["Al cerrar la ventana, la aplicación sigue en el área de notificación. Para salir del todo, usa «Salir» en el menú del icono.", "Closing the window keeps the app in the notification area. To quit completely, use \u201cExit\u201d in the icon menu.", "Ao fechar a janela, o aplicativo continua na área de notificação. Para sair de vez, use «Sair» no menu do ícone.", "À la fermeture de la fenêtre, l'application reste dans la zone de notification. Pour la quitter, utilisez « Quitter » dans le menu de l'icône.", "Chiudendo la finestra, l'app resta nell'area di notifica. Per uscire del tutto, usa «Esci» nel menu dell'icona."],
        ["settings.excludedCount.one"] = ["{0} paquete excluido.", "{0} excluded package.", "{0} pacote excluído.", "{0} paquet exclu.", "{0} pacchetto escluso."],
        ["settings.excludedCount.other"] = ["{0} paquetes excluidos.", "{0} excluded packages.", "{0} pacotes excluídos.", "{0} paquets exclus.", "{0} pacchetti esclusi."],
        ["settings.excludedEmpty"] = ["No hay paquetes excluidos. Para excluir uno, selecciónalo en la ventana principal y pulsa Supr.", "There are no excluded packages. To exclude one, select it in the main window and press Delete.", "Não há pacotes excluídos. Para excluir um, selecione-o na janela principal e pressione Delete.", "Aucun paquet exclu. Pour en exclure un, sélectionnez-le dans la fenêtre principale et appuyez sur Suppr.", "Nessun pacchetto escluso. Per escluderne uno, selezionalo nella finestra principale e premi Canc."],
        ["settings.removeExcluded"] = ["Quitar", "Remove", "Remover", "Retirer", "Rimuovi"],
        ["settings.removeExcludedAccessible"] = ["Quitar {0} de los excluidos", "Remove {0} from the excluded packages", "Remover {0} dos excluídos", "Retirer {0} des paquets exclus", "Rimuovi {0} dai pacchetti esclusi"],
        ...
        ["uninstall.foundCount.one"] = ["Se encontró {0} programa instalado.", "{0} installed program was found.", "{0} programa instalado encontrado.", "{0} programme installé trouvé.", "Trovato {0} programma installato."],
        ["uninstall.foundCount.other"] = ["Se encontraron {0} programas instalados.", "{0} installed programs were found.", "{0} programas instalados encontrados.", "{0} programmes installés trouvés.", "Trovati {0} programmi installati."],
        ...
        ["uninstall.countAll.one"] = ["{0} programa", "{0} program", "{0} programa", "{0} programme", "{0} programma"],
        ["uninstall.countAll.other"] = ["{0} programas", "{0} programs", "{0} programas", "{0} programmes", "{0} programmi"],
        ...
        ["cleanup.foundResidues.one"] = ["Se encontró {0} residuo potencial.", "{0} potential leftover was found.", "{0} resíduo potencial encontrado.", "{0} résidu potentiel trouvé.", "Trovato {0} residuo potenziale."],
        ["cleanup.foundResidues.other"] = ["Se encontraron {0} residuos potenciales.", "{0} potential leftovers were found.", "{0} resíduos potenciais encontrados.", "{0} résidus potentiels trouvés.", "Trovati {0} residui potenziali."],
        ...
        ["cleanup.rowAccessible"]    = ["{0}, {1}, {2}, de {3}", "{0}, {1}, {2}, from {3}", "{0}, {1}, {2}, de {3}", "{0}, {1}, {2}, de {3}", "{0}, {1}, {2}, di {3}"],
        ["cleanup.selectAccessible"] = ["Seleccionar {0} para eliminar", "Select {0} for deletion", "Selecionar {0} para excluir", "Sélectionner {0} pour la suppression", "Seleziona {0} per l'eliminazione"],
        ["cleanup.confirmDeleteBody.one"] = ["¿Eliminar {0} elemento seleccionado?\n\n  • {1}\n\nEsta acción no se puede deshacer.", "Delete {0} selected item?\n\n  • {1}\n\nThis action cannot be undone.", "Excluir {0} item selecionado?\n\n  • {1}\n\nEsta ação não pode ser desfeita.", "Supprimer {0} élément sélectionné ?\n\n  • {1}\n\nCette action est irréversible.", "Eliminare {0} elemento selezionato?\n\n  • {1}\n\nQuesta azione non può essere annullata."],
        ["cleanup.confirmDeleteBody.other"] = ["¿Eliminar {0} elementos seleccionados?\n\n  • {1}\n\nEsta acción no se puede deshacer.", "Delete {0} selected items?\n\n  • {1}\n\nThis action cannot be undone.", "Excluir {0} itens selecionados?\n\n  • {1}\n\nEsta ação não pode ser desfeita.", "Supprimer {0} éléments sélectionnés ?\n\n  • {1}\n\nCette action est irréversible.", "Eliminare {0} elementi selezionati?\n\n  • {1}\n\nQuesta azione non può essere annullata."],
        ...
        ["history.summaryAll.one"] = ["{0} registro cargado. Éxito: {1}. Fallidos: {2}.", "{0} record loaded. Success: {1}. Failed: {2}.", "{0} registro carregado. Sucesso: {1}. Falharam: {2}.", "{0} enregistrement chargé. Réussites : {1}. Échecs : {2}.", "{0} record caricato. Riusciti: {1}. Falliti: {2}."],
        ["history.summaryAll.other"] = ["{0} registros cargados. Éxito: {1}. Fallidos: {2}.", "{0} records loaded. Success: {1}. Failed: {2}.", "{0} registros carregados. Sucesso: {1}. Falharam: {2}.", "{0} enregistrements chargés. Réussites : {1}. Échecs : {2}.", "{0} record caricati. Riusciti: {1}. Falliti: {2}."],
        ["history.summaryFiltered.one"] = ["{0} de {1} registro. Éxito: {2}. Fallidos: {3}.", "{0} of {1} record. Success: {2}. Failed: {3}.", "{0} de {1} registro. Sucesso: {2}. Falharam: {3}.", "{0} sur {1} enregistrement. Réussites : {2}. Échecs : {3}.", "{0} di {1} record. Riusciti: {2}. Falliti: {3}."],
        ["history.summaryFiltered.other"] = ["{0} de {1} registros. Éxito: {2}. Fallidos: {3}.", "{0} of {1} records. Success: {2}. Failed: {3}.", "{0} de {1} registros. Sucesso: {2}. Falharam: {3}.", "{0} sur {1} enregistrements. Réussites : {2}. Échecs : {3}.", "{0} di {1} record. Riusciti: {2}. Falliti: {3}."],
        ...
        ["reason.networkError"]   = ["Error de red. Comprueba tu conexión a internet.", "Network error. Check your internet connection.", "Erro de rede. Verifique sua conexão com a internet.", "Erreur réseau. Vérifiez votre connexion Internet.", "Errore di rete. Verifica la connessione a Internet."],
